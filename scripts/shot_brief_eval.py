...
это совпадение ПРЕДМЕТА с брифом автора. Совпало — кадр почти наверняка
...
Второй предел, столь же честный: брифы автора написаны уже зная, что
...
def main(argv):
    ...
    print(f"Юнитов {total}, эталонных брифов автора {ref_present}")
