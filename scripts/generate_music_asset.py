...
MUSIC_LUFS_TARGET = "I=-30:TP=-3:LRA=3"
# Разрыв с голосом изменился 02.09 НЕ здесь: цель голоса в pipeline_smart.py
# (LOUDNORM_TARGET_I) сдвинулась -16 -> -14 LUFS, а -30 здесь осталась той
# же — раньше зазор был ~14дБ (-30 минус -16), сейчас ~16дБ (-30 минус -14).
# Это значение НЕ трогалось намеренно (баланс музыка/голос — творческое
# решение, не техническая правка) — если 16дБ звучит иначе, чем задумано,
# решение поднимать/не поднимать музыку — на пользователе, не молчаливый
# побочный эффект правки громкости голоса. См. CHANNEL.md house style.
